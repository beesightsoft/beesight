...
const changeAppNameSync = (projectPath, appId, newAppName, currentAppName) => {
  if (newAppName != currentAppName) {
    ...
    //Rename file name
    files.renamePath(
      projectPath + '/ios/' + currentAppName + '.xcodeproj',
      projectPath + '/ios/' + newAppName + '.xcodeproj'
    )
    files.renamePath(
      projectPath + '/ios/' + newAppName + '.xcodeproj/xcshareddata/xcschemes/' + currentAppName + '.xcscheme',
      projectPath + '/ios/' + newAppName + '.xcodeproj/xcshareddata/xcschemes/' + newAppName + '.xcscheme'
    )

    files.renamePath(
      projectPath + '/ios/' + newAppName + '/' + currentAppName + '.entitlements',
      projectPath + '/ios/' + newAppName + '/' + newAppName + '.entitlements'
    )
    files.renamePath(
      projectPath + '/ios/' + newAppName + 'Tests/' + currentAppName + 'Tests.m',
...
const changeAppIdSync = (projectPath, appName, newAppId, currentAppId) => {
  if (newAppId != currentAppId) {
    ...
    const currPath = srcPath + '/' + currentAppId.split('.').join('/') + '/'
