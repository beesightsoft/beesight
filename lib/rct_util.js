    ...
    if (newAppName != currentAppName) {
        ...
        try {
            ...
            var paths = [
                ...
                projectPath + '/android/app/src/main/java/' + appId.split('.').join(path.sep) + '/MainActivity.java',
...
const changeAppIdSync = (projectPath, appName, newAppId, currentAppId) => {
    if (newAppId != currentAppId) {
        ...
        var paths = [
            ...
            projectPath + '/android/app/src/main/java/' + currentAppIdappId.split('.').join(path.sep) + '/MainActivity.java',
            projectPath + '/android/app/src/main/java/' + currentAppIdappId.split('.').join(path.sep) + '/MainApplication.java',
        ];
        ...
        const newPath = srcPath + '/' + newAppIdappId.split('.').join(path.sep) + '/';
